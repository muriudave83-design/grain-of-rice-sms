...
exports.computeGradesForSubject = computeGradesForSubject;
const client_1 = require("../prisma/client");
async function computeGradesForSubject({ classId, subjectId, termId, }) {
    return client_1.prisma.$transaction(async (tx) => {
         ...
         * 4. Build lookup maps
         */
        const assessmentMap = new Map(assessments.map((a) => [
            a.id,
